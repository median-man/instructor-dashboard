# Bootcamp Instructor Dashboard (BID)

The missing tool for Bootcamp Instructors and TAs. Provides a dashboard tailored to the instructor's needs that is currently missing from the suite of tools made available to instructors.
...
Please open an issue [here](https://github.com/median-man/instructor-dashboard/issues/new).
